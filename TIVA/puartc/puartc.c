// LABORATORIO 5
// For the following exercise you will generate a 3-state sequence with TIVA’s user
//LEDs. This sequence must work using one timer and using SSH you must be
//able to change the second the timer works. For this you should:
